...
using LGarden.Models.TokenAuth;
...
{
    public abstract class LGardenWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LGardenWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LGardenWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LGardenDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LGardenDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LGardenDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LGardenDbContext, Task<T>> func)
        {
            T result;
